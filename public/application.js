...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onSignUp = function onSignUp(event) {
	  ...
	  api.signUp(data).done(ui.signUpSuccess).fail(ui.fail);
	};
	...
	var onCreateDate = function onCreateDate(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  // const date = $("input[name='credentials[date-create]']").val()
	  // console.log(date)
	  api.createDate(data).then(ui.onCreateDateSuccess).catch(ui.fail);
	};

	var onGetDateMasters = function onGetDateMasters(event) {
	  event.preventDefault();
	  console.log('onGetDateMasters in events.js');
	  api.getDateMasters().then(ui.getDateMastersSuccess).catch(ui.fail);
	};

	var onGetFoodLogs = function onGetFoodLogs(event) {
	  event.preventDefault();
	  console.log('onGetFoodLogs in events.js');
	  api.getFoodLogs().then(ui.getFoodLogsSuccess).catch(ui.fail);
	};

	var onGetAllergicReactionLogs = function onGetAllergicReactionLogs(event) {
	  event.preventDefault();
	  console.log('onGetAllergicReactionLogs in events.js');
	  api.getAllergicReactionLogs().then(ui.getAllergicReactionLogsSuccess).catch(ui.fail);
	};

	var onGetFlByDate = function onGetFlByDate(event) {
	  event.preventDefault();
	  // Get input 'yyyy-mm-dd'
	  var dateFilter = $('#fl-date-input').val();

	  console.log('FL dateFilter === ' + dateFilter);
	  console.log('onGetFlByDate in events.js');
	  // pass input to API call
	  api.getFlByDate(dateFilter).then(ui.getFlByDateSuccess).catch(ui.fail);
	};

	var onGetArlByDate = function onGetArlByDate(event) {
	  event.preventDefault();
	  var dateFilter = $('#arl-date-input').val();

	  console.log('ARL dateFilter === ' + dateFilter);
	  console.log('onGetFlByDate in events.js');
	  // pass input to API call
	  api.getArlByDate(dateFilter).then(ui.getArlByDateSuccess).catch(ui.fail);
	};

	var onCreateFoodLog = function onCreateFoodLog(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  console.log('onCreateFoodLog in event.js');
	  console.log(data); // returns food_log object
	  api.createFoodLog(data).then(ui.createFoodLogSuccess).catch(ui.fail);
	};

	var onCreateAllergicReactionLog = function onCreateAllergicReactionLog(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  console.log('onCreateAllergicReactionLog in event.js');
	  console.log(data); // returns food_log object
	  api.createAllergicReactionLog(data).then(ui.createAllergicReactionLogSuccess).catch(ui.fail);
	};

	var onUpdateDate = function onUpdateDate(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  console.log('onUpdateDate in events.js');
	  console.log(data);
	  api.updateDate(data).then(ui.updateDateSuccess).catch(ui.fail);
	};

	var onDeleteDate = function onDeleteDate(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.deleteDate(data).then(ui.onDeleteDateSuccess).catch(ui.fail);
	};

	var onSignUpPrompt = function onSignUpPrompt() {
	  $(this).hide();
	  $('#sign-up').show();
	};

	var emptyInputVals = function emptyInputVals(event) {
	  event.preventDefault();
	  $('input').val('');
	};

	var showMyAcct = function showMyAcct() {
	...
	var closeMyAcct = function closeMyAcct() {
	  $('.my-acct').hide();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var createDate = function createDate(data) {
	  console.log(data);
	  return $.ajax({
	...
	var updateDate = function updateDate(data) {
	  ...
	  var oldDate = data.date_master.date_old;
	  return $.ajax({
	    method: 'PATCH',
	...
	var getDateMasters = function getDateMasters(data) {
	...
	var getFoodLogs = function getFoodLogs() {
	...
	var getAllergicReactionLogs = function getAllergicReactionLogs() {
	...
	var getFlByDate = function getFlByDate(data) {
	...
	var getArlByDate = function getArlByDate(data) {
	...
	var createAllergicReactionLog = function createAllergicReactionLog(data) {
	  console.log('createAllergicReactionLog in api.js');
	  console.log(data.allergic_reaction_log.date_master_id);
	  // date to be converted to date_master_id
	  var date = data.allergic_reaction_log.date_master_id;
	  return $.ajax({
	    method: 'POST',
	...
	var deleteDate = function deleteDate(data) {
	  console.log(data);
	  var date = data.date_master.date;
	  console.log(date);
	  return $.ajax({
	...
	module.exports = {
	  ...
	  getAllergicReactionLogs: getAllergicReactionLogs,
	  getDateMasters: getDateMasters,
	  getFlByDate: getFlByDate,
	  getArlByDate: getArlByDate,
	  getFormFields: getFormFields,
	  createDate: createDate,
	  updateDate: updateDate,
	  deleteDate: deleteDate,
	  createFoodLog: createFoodLog,
	  createAllergicReactionLog: createAllergicReactionLog
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports) {
	...
	module.exports = {
	  host: 'https://food-diary-api.herokuapp.com'
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onCreateDateSuccess = function onCreateDateSuccess(data) {
	...
	var onUpdateDateSuccess = function onUpdateDateSuccess(data) {
	  // console.log(data)
	};

	var onDeleteDateSuccess = function onDeleteDateSuccess(data) {
	  // console.log(data)
	};

	var getDateMastersSuccess = function getDateMastersSuccess(data) {
	  $('.date-master-date').html('');
	  var date = data.date_masters;
	  if (date.length > 0) {
	...
	var getFoodLogsSuccess = function getFoodLogsSuccess(data) {
	  $('.food-description, .food-time, .food-date').html('');
	  if (data.food_logs.length > 0) {
	    for (var i = 0; i < data.food_logs.length; i++) {
	...
	var getAllergicReactionLogsSuccess = function getAllergicReactionLogsSuccess(data) {
	  $('.reaction-symptom, .reaction-time, .reaction-date').html('');
	  var ARLogs = data.allergic_reaction_logs;
	  if (ARLogs.length > 0) {
	...
	var getFlByDateSuccess = function getFlByDateSuccess(data) {
	  $('.food-description, .food-date, .food-time').html('');
	  var foodLogs = data.food_logs;
	...
	var getArlByDateSuccess = function getArlByDateSuccess(data) {
	  $('.reaction-symptom, .reaction-time, .reaction-date').html('');
	  var ARLogs = data.allergic_reaction_logs;
	  if (ARLogs.length > 0) {
	    for (var i = 0; i < ARLogs.length; i++) {
	...
	var createFoodLogSuccess = function createFoodLogSuccess(data) {
	  // console.log(data)
	};

	var createAllergicReactionLogSuccess = function createAllergicReactionLogSuccess(data) {
	  // console.table(data)
	};
	...
	module.exports = {
	  ...
	  getFoodLogsSuccess: getFoodLogsSuccess,
	  getAllergicReactionLogsSuccess: getAllergicReactionLogsSuccess,
	  getDateMastersSuccess: getDateMastersSuccess,
	  getFlByDateSuccess: getFlByDateSuccess,
	  getArlByDateSuccess: getArlByDateSuccess,
	  signUpSuccess: signUpSuccess,
	  onCreateDateSuccess: onCreateDateSuccess,
	  onUpdateDateSuccess: onUpdateDateSuccess,
	  onDeleteDateSuccess: onDeleteDateSuccess,
	  createFoodLogSuccess: createFoodLogSuccess,
	  createAllergicReactionLogSuccess: createAllergicReactionLogSuccess
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "body {\n  font-family: 'Josefin Sans', sans-serif !important;\n  background-color: rgba(16, 131, 143, 0.89) !important;\n}\n\nheader * {\n  display: inline-block;\n  margin: 15px;\n}\n\nh1 {\n  border-bottom: 3px solid black;\n}\n\n.sign-up-prompt {\n  background-color: rgba(223, 174, 47, 0.66);\n  padding: 10px;\n  width: 400px;\n  border-radius: 5px;\n  text-align: center;\n  margin-top: 40px;\n}\n\nbutton[name='create-log'], button[name='see-logs'] {\n  margin-top: 20px;\n  width: 150px;\n}\n", ""]);
